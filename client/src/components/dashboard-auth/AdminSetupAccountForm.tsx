...
export default function AdminSetupAccountForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!token) {
      setError("No setup link found. Ask a superadmin to resend your invite.");
      return;
    }
    ...
    setError("");
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE_URL}/api/admin/setup-account`, {
        method: "POST",
  ...
  if (success) {
    return (
      <div className="text-center">
        ...
        <h3 className="mb-2 text-xl font-bold text-gray-800">Account activated!</h3>
  ...
  return (
    <div>
      <div className="mb-8 text-center">
        <h2 className="text-3xl font-bold text-gray-900 md:text-4xl">Set your password</h2>
