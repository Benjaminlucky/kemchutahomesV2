...
import { milestones } from "@/lib/companyData";
    ...
    >
      <div className="mx-auto w-11/12 py-20 md:py-32">
        ...
        >
          ...
          >
            Founded in 2018, Kemchuta Homes has grown from a modest local
            firm into a prominent industry leader. Our journey is defined by
            a steadfast commitment to excellence, passion for innovation, and
