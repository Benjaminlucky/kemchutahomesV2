...
export default function CompanyIntro() {
  return (
    ...
    >
      <div className="mx-auto w-11/12 pt-16 pb-12 md:pt-24 md:pb-16">
        <motion.p
          {...fade(0)}
          style={{
            fontSize: 11,
        ...
        >
          ...
          >
            At Kemchuta Homes, we&rsquo;re more than a real estate business
            &mdash; we&rsquo;re your trusted partner in turning property
            ownership dreams into reality. Real estate is not just an
            investment; it&rsquo;s about building your future, securing your
            legacy, and finding the perfect place to call home.
          </p>
        </motion.div>
      </div>
      ...
      >
        ...
        >
          ...
          >
            Kemchuta Homes &middot; Lekki &amp; Asaba
          </p>
          <p
