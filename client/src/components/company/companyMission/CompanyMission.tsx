      ...
      <div className="mx-auto w-11/12 py-20 md:py-32">
        ...
        >
          ...
          >
            ...
            >
              &ldquo;We envision a future where every individual&rsquo;s
              dream of owning their ideal home is realized &mdash; through
              real estate that inspires and elevates.&rdquo;
            </p>
          </motion.div>
        </div>
