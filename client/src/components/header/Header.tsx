  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className={`relative flex items-center gap-1.5 whitespace-nowrap text-sm font-medium transition-colors duration-200 xl:text-base ${
          isClientActive
...
export default function Header() {
  ...
  return (
    <div className="mainNavWrapper w-full">
      {/* ── DESKTOP ─────────────────────────────────────────────────────── */}
      {/* lg, not md: nav links + Buy2Sell pill + Client Portal dropdown + two
          Realtor buttons need close to 1024px — at exactly 768px (md) they
          overflowed the viewport and dragged every page into horizontal
          scroll. Same fix, same reason, as EstatesTable's table/card
          breakpoint. */}
      <div className="hidden lg:block" style={navBarStyle}>
        <div
        ...
        >
          ...
          <nav className="flex items-center gap-2 xl:gap-6">
            {mainLink.map((link) => (
              ...
              >
                <Link
                  href={link.link}
                  className="text-sm transition-colors duration-200 xl:text-base"
                >
                  {link.name}
                </Link>
              </div>
          ...
          <div className="flex flex-shrink-0 items-center gap-2">
            <Link
              href="/login"
              className="rounded-full border-2 px-4 py-2 text-xs font-semibold uppercase whitespace-nowrap transition-all duration-200 xl:px-5 xl:text-sm"
            ...
            <Link
              href="/signup"
              className="rounded-full px-4 py-2 text-xs font-bold text-white uppercase whitespace-nowrap transition-all duration-200 xl:px-5 xl:text-sm"
              style={{
      ...
      {/* ── MOBILE ──────────────────────────────────────────────────────── */}
      <div className="lg:hidden" style={navBarStyle}>
