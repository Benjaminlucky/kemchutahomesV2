...
const DURATIONS = [
  {
    ...
    label: "6 Months",
    days: 180,
    roiKey: "roiPercent6Months" as const,
  },
  {
    key: "12 Months",
    label: "12 Months",
    days: 360,
    roiKey: "roiPercent12Months" as const,
  },
  {
    key: "18 Months",
    label: "18 Months",
    days: 540,
    roiKey: "roiPercent18Months" as const,
  },
];
const ID_TYPES = [
  "NIN",
...
export default function Buy2SellPage({
  ...
  initialRoi: ROISettings;
}) {
  const params = useSearchParams();

  const [step, setStep] = useState(0);
  const [roi] = useState<ROISettings>(initialRoi);
  const [amount, setAmount] = useState(5_000_000);
  const [custom, setCustom] = useState("");
  const [duration, setDuration] = useState(
    params.get("duration") || "12 Months",
  );
  const [loading, setLoading] = useState(false);
  const [errors, setErrors] = useState<
    Partial<Record<keyof Kyc, string>> & { submit?: string }
  >({});
  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/buy2sell/leads`,
        {
          method: "POST",
  ...
  const inpStyle = (field: keyof Kyc): React.CSSProperties => ({
    ...inpBase,
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <defs>
            <pattern id="b2sgrid" width="48" height="48" patternUnits="userSpaceOnUse">
        ...
        <div
          style={{
            ...
            height: 320,
            borderRadius: "50%",
            background: "radial-gradient(circle,rgba(180,140,255,0.35) 0%,transparent 70%)",
            pointerEvents: "none",
          }}
        />
        <div
          style={{
            ...
            height: 240,
            borderRadius: "50%",
            background: "radial-gradient(circle,rgba(100,60,200,0.4) 0%,transparent 70%)",
            pointerEvents: "none",
          }}
        />
        ...
        >
          <svg viewBox="0 0 1440 60" preserveAspectRatio="none" style={{ width: "100%", height: "100%" }}>
            <path d="M0,40 C360,80 1080,0 1440,40 L1440,60 L0,60 Z" fill="#f5f0ff" />
          </svg>
        </div>
      </div>
          ...
          <AnimatePresence mode="wait">
            {step === 0 && (
              ...
              >
                ...
                <div style={{ marginBottom: 28 }}>
                  ...
                  <p style={{ fontSize: 11, color: "#b0a0d0", margin: "6px 0 0" }}>
                      ...
                      return (
                        <button
                          ...
                          style={{
                            ...
                            boxShadow: sel ? `0 8px 24px ${PURPLE}30` : "none",
                        ...
                        >
                          <p
                            style={{
                              fontSize: 13,
                              fontWeight: 800,
                              color: sel ? "rgba(255,255,255,0.8)" : "#6b7280",
                              margin: "0 0 6px",
                            }}
                          >
                            {d.label}
                          ...
                          <p
                            style={{
                              fontSize: 11,
                              fontWeight: 700,
                              color: sel ? "rgba(255,255,255,0.65)" : "#9ca3af",
                              margin: "0 0 8px",
                            }}
                          >
                            ROI
                          ...
                          <div
                            style={{
                              height: 1,
                              background: sel ? "rgba(255,255,255,0.15)" : "#ede9f8",
                              margin: "0 0 8px",
                            }}
                          />
                          <p
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(2,1fr)", gap: 12 }}>
                    {(
                      ...
                      >
                        ...
                        <p style={{ fontSize: 15, fontWeight: 900, color: c, margin: 0, letterSpacing: "-0.03em" }}>
                          {v}
                        </p>
                      </div>
                    ))}
            ...
            {step === 1 && (
              ...
              >
                ...
                <p style={{ color: "#9ca3af", fontSize: 14, margin: "0 0 28px" }}>
                  Complete your KYC information to submit your investment application.
                </p>
                ...
                >
                  {(
                    ...
                    <div key={l} style={{ flex: 1, minWidth: 100 }}>
                      ...
                      <p style={{ fontSize: 13, fontWeight: 900, color: DARK, margin: 0 }}>{v}</p>
                    </div>
                  ))}
                </div>
                ...
                <div style={{ display: "flex", gap: 12, marginTop: 8 }}>
                  ...
                  >
                    {loading ? "Submitting…" : "Submit Investment Application →"}
                  </button>
                </div>
              </motion.div>
            )}
            ...
            {step === 2 && result && (
              ...
              >
                ...
                <h2 style={{ fontSize: 26, fontWeight: 900, color: "#0f0a1e", margin: "0 0 8px", letterSpacing: "-0.04em" }}>
                  Application Submitted!
                </h2>
                <p style={{ color: "#6b7280", fontSize: 14, margin: "0 auto 24px", lineHeight: 1.7, maxWidth: 420 }}>
                ...
                >
                  ...
                  {(
                    [
                      ...
                      ["Principal Amount", fmtNGN(result.principalAmount)],
                      ["Duration", result.duration],
                      ["ROI Rate (locked)", `${result.roiPercent}%`],
                      ["Total at Maturity", fmtNGN(result.expectedPayout)],
                    ] as const
                  ).map(([l, v]) => (
                    <div
                      key={l}
                    ...
                    >
                      ...
                      <span style={{ fontSize: 13, fontWeight: 800, color: "#0f0a1e" }}>{v}</span>
                    </div>
                  ))}
                </div>
                ...
                {clientExists ? (
                  ...
                  >
                    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                      ...
                      <p style={{ fontSize: 15, fontWeight: 800, color: "#0f0a1e", margin: 0 }}>
                ...
                <Link href="/" style={{ fontSize: 12, color: "#9ca3af", textDecoration: "underline" }}>
                  Back to home
                </Link>
              </motion.div>
            )}
      ...
      {step === 0 && (
        <div style={{ background: "#fff", padding: "64px 24px", borderTop: "1px solid #f0eeff" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(150px,1fr))", gap: 24 }}>
              {(
                [
                  ...
                  { n: "02", t: "Pick Duration", d: "6, 12 or 18 months", icon: "📅" },
                  { n: "03", t: "Complete KYC", d: "Submit your details & ID", icon: "📋" },
                  { n: "04", t: "Make Payment", d: "Transfer to our account", icon: "🏦" },
                  { n: "05", t: "Investment Live", d: "Countdown starts on approval", icon: "🚀" },
                  { n: "06", t: "Get Paid", d: "Principal + ROI at maturity", icon: "🎉" },
                ] as const
              ).map(({ n, t, d, icon }) => (
                <div key={n} style={{ textAlign: "center" }}>
                  ...
                  <p style={{ fontSize: 10, fontWeight: 800, color: PURPLE, margin: "0 0 4px", letterSpacing: "0.06em" }}>
                    {n}
                  </p>
                  <p style={{ fontSize: 13, fontWeight: 700, color: "#0f0a1e", margin: "0 0 4px" }}>{t}</p>
                  <p style={{ fontSize: 11, color: "#9ca3af", margin: 0 }}>{d}</p>
                </div>
              ))}
            </div>
          </div>
