...
export default function Whychoose() {
  ...
  const slideRight = {
    hidden: { opacity: 0, x: 60 },
    visible: { opacity: 1, x: 0, transition: { duration: 0.9, ease: [0.22, 1, 0.36, 1] as const, delay: 0.1 } },
  };
      ...
      <div className="relative z-10 mx-auto w-11/12 py-20 md:w-10/12 md:py-32">
        ...
        >
          ...
          <h2
            ...
            style={{ fontSize: "clamp(2rem, 5.5vw, 4.5rem)", letterSpacing: "-0.04em", lineHeight: 1.1 }}
          >
            Why Choose{" "}
            <span style={{ color: "rgba(255,255,255,0.65)" }}>Kemchuta</span> Homes
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          >
            <div className="relative w-full max-w-md">
              <div
                className="absolute -top-5 -right-5 z-20 rounded-2xl px-4 py-3"
                style={{
              ...
              >
                ...
                <p style={{ fontSize: 22, fontWeight: 900, color: PURPLE, letterSpacing: "-0.04em" }}>2018</p>
              </div>

              <div style={{ position: "relative", aspectRatio: "2/3", borderRadius: 20, overflow: "hidden", boxShadow: "0 40px 80px rgba(0,0,0,0.3)" }}>
                <Image
          ...
          <motion.div variants={slideRight} initial="hidden" animate={isInView ? "visible" : "hidden"}>
            <div style={{ background: "rgba(255,255,255,0.97)", borderRadius: 24, padding: "40px 36px", boxShadow: "0 40px 80px rgba(0,0,0,0.25)" }}>
              <p className="mb-8 text-sm leading-relaxed text-gray-500" style={{ maxWidth: 420 }}>
                ...
                {whychooseus.map((perk, i) => (
                  ...
                  >
                    <div
                      ...
                      style={{ background: "rgba(112,12,235,0.08)", border: "1px solid rgba(112,12,235,0.12)" }}
                    >
                      <Send size={18} style={{ color: PURPLE }} />
                    </div>
                    <div>
                      <h4 className="mb-0.5 font-black text-gray-900" style={{ fontSize: "clamp(0.85rem, 1.5vw, 1.05rem)", letterSpacing: "-0.02em" }}>
                        {perk.why}
                      </h4>
              ...
              <div className="mt-10 border-t border-gray-100 pt-6">
                <Link
                  href="/developments"
                  className="inline-flex items-center gap-2 text-sm font-bold tracking-wider uppercase transition-all hover:gap-3"
                  style={{ color: PURPLE }}
                >
                  Explore Our Estates
